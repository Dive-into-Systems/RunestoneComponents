...
def generateOffsetList(ads_num, offset_bits):
...
def generateTagNIndexList(ads_num, tag_bits, index_bits):
...
def main_bound(ads_num, offset_bits, index_bits, tag_bits):
    ...
    for i in range(ads_num):
        generateTagNIndexList(ads_num, tag_bits, index_bits)
        generateOffsetList(ads_num, offset_bits)
