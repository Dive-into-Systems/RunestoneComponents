$.i18n().load({
    en: {
        ...
        msg_cacheinfo_incorrect_0: "Incorrect. Hint: block size has something to do with the offset bits", 
        msg_cacheinfo_incorrect_1: "Incorrect. Hint: number of rows has something to do with the index bits",
        msg_cacheinfo_incorrect_2: "Incorrect. Hint: number of lines has something to do with the index bits and setassociatives",
